...
function fixFile(filePath) {
  try {
    ...
    if (
      content.includes("interface SubscriptionTiers") &&
      content.includes("const SubscriptionTiers")
    ) {
...
const fixedCount =
  walkDirectory("./client/src") + walkDirectory("./server") + walkDirectory("./shared");
