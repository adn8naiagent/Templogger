import { ChecklistSchedule, GeneratedInstance, ScheduleError } from "@shared/checklist-types";
...
export class SchedulingUtils {
  ...
  static generateInstances(schedule: ChecklistSchedule, dateRange: DateRange): GeneratedInstance[] {
  ...
  private static formatDisplayDate(
    targetDate: string,
    cadence: "DAILY" | "DOW" | "WEEKLY"
  ): string {
    if (cadence === "WEEKLY") {
