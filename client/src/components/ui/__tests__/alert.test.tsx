...
describe('Alert Components', () => {
  describe('Alert', () => {
    ...
    it('spreads additional props', () => {
      render(<Alert id="test-alert" data-testid="alert">Alert</Alert>);
      const alert = screen.getByTestId('alert');
  ...
  describe('AlertTitle', () => {
    ...
    it('spreads additional props', () => {
      render(<AlertTitle id="test-title" data-testid="title">Title</AlertTitle>);
      const title = screen.getByTestId('title');
  ...
  describe('AlertDescription', () => {
    ...
    it('spreads additional props', () => {
      render(<AlertDescription id="test-desc" data-testid="description">Description</AlertDescription>);
      const description = screen.getByTestId('description');
  ...
  describe('Complete Alert Structure', () => {
    it('renders a complete alert with title, description, and icon', () => {
      ...
      expect(screen.getByText('This is an important message that you should read carefully.')).toBeInTheDocument();
    });
  ...
  describe('Accessibility', () => {
    ...
    it('handles keyboard focus appropriately', () => {
      render(<Alert tabIndex={0} data-testid="focusable-alert">Focusable alert</Alert>);
