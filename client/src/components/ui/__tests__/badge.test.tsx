...
describe("Badge Component", () => {
  ...
  describe("Focus and Interaction", () => {
    ...
    it("handles mouse events", () => {
      ...
      render(
        <Badge onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} data-testid="badge">
          Hover Badge
        </Badge>
      );
  ...
  describe("Styling Variants", () => {
    ...
    it("combines variant and custom classes correctly", () => {
      render(
        <Badge variant="secondary" className="text-xl" data-testid="badge">
          Large Secondary
        </Badge>
      );
      const badge = screen.getByTestId("badge");
  ...
  describe("Edge Cases", () => {
    ...
    it("handles invalid variant gracefully", () => {
      render(
        <Badge
          variant={
            "invalid" as "default" | "secondary" | "destructive" | "outline" | null | undefined
          }
          data-testid="badge"
        >
          Badge
  ...
  describe("Error Scenarios", () => {
    it("handles invalid onClick prop type", () => {
      ...
      render(
        <Badge onClick={mockInvalidHandler} data-testid="badge">
          Badge
        </Badge>
      );
      const badge = screen.getByTestId("badge");
    ...
    it("handles invalid event handlers gracefully", () => {
      ...
      render(
        <Badge onMouseEnter={undefined} data-testid="badge">
          Badge
        </Badge>
      );
      const badge = screen.getByTestId("badge");
  ...
  describe("Accessibility", () => {
    it("supports ARIA attributes", () => {
      render(
        <Badge aria-label="Status badge" aria-describedby="status-description" data-testid="badge">
          Active
        </Badge>
      );
    ...
    it("can be used as a button with proper role", () => {
      const handleClick = jest.fn();
      render(
        <Badge role="button" onClick={handleClick} tabIndex={0} data-testid="badge">
          Clickable Badge
        </Badge>
      );
