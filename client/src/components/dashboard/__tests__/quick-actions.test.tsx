...
jest.mock("lucide-react", () => ({
  Play: ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
    <div className={className} data-testid="play-icon" {...props} />
  ),
  Terminal: ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
    <div className={className} data-testid="terminal-icon" {...props} />
  ),
  ...
  Upload: ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
    <div className={className} data-testid="upload-icon" {...props} />
  ),
}));
...
describe("QuickActions Component", () => {
  ...
  it("displays correct titles and descriptions for each action", () => {
    ...
    expect(screen.getByTestId("description-start-dev-servers")).toHaveTextContent(
    ...
    expect(screen.getByTestId("description-build-project")).toHaveTextContent(
