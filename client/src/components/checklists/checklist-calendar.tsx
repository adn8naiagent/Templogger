          ...
          >
            ...
            {instances.length > 0 && (
              <div className="space-y-1">
                ...
                {instances.length > 2 && (
                  <div className="text-xs text-muted-foreground">+{instances.length - 2} more</div>
                )}
              </div>
            )}
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track your scheduled checklist requirements</p>
        </div>
      ...
      <Dialog open={!!selectedDate} onOpenChange={() => setSelectedDate(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Checklist requirements for this date</DialogDescription>
          </DialogHeader>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {instance.status === "REQUIRED" && (
                          <Button size="sm" onClick={() => setCompletingInstance(instance)}>
                            Complete
                          </Button>
                        )}
                      </div>
